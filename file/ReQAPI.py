...
class APIClient:
 def __init__(self):
  ...
  self.language = "en"  # ĐÃ THAY: vn → en
  self.base_url = detail_vers["server_url"] if detail_vers else "https://loginbp.ggpolarbear.com/"
  self.client_version = detail_vers["remote_version"] if detail_vers else "1.126.18"
  self.release_version = detail_vers["latest_release_version"] if detail_vers else "OB54"
 ...
 def MajorLogin(self):
  ...
  fields[4] = "free fire"
  fields[5] = 4
  fields[7] = self.client_version                    # 1.126.18
  fields[8] = "Android OS 14 / API-34"              # ĐÃ THAY: 13 → 14, API-33 → API-34
  fields[9] = "Handheld"
  fields[10] = "Viettel"                            # ĐÃ THAY: Verizon Wireless → Viettel
  fields[11] = "5G"                                 # ĐÃ THAY: WIFI → 5G
  fields[12] = 1440                                 # ĐÃ THAY: 1280 → 1440
  fields[13] = 3120                                 # ĐÃ THAY: 960 → 3120
  fields[15] = "ARM64 FP ASIMD AES | 3200 | 12"     # ĐÃ THAY: 2800 → 3200, 8 → 12
  fields[16] = 8192                                 # ĐÃ THAY: 5951 → 8192
  fields[17] = "Adreno (TM) 740"                    # ĐÃ THAY: 640 → 740
  fields[18] = "OpenGL ES 3.2"
  fields[19] = "Google|a1b2c3d4-e5f6-7890-abcd-ef1234567890"  # ĐÃ THAY Android ID
  fields[20] = "192.168.1.100"                      # ĐÃ THAY: 20.81.159.0 → 192.168.1.100
  fields[21] = self.language
  fields[22] = str(self._data.open_id)
  fields[23] = int(self._data.login_platform)
  fields[24] = "Handheld"
  fields[25] = "Xiaomi 14 Pro"                      # ĐÃ THAY: Samsung SM-S908E → Xiaomi 14 Pro
  fields[29] = str(self._data.access_token)
  fields[30] = 1
  fields[41] = "O2"
  fields[42] = "5G"                                 # ĐÃ THAY: WIFI → 5G
 ...
 def GetLoginData(self):
  try:
   ...
   fields[4]  = "free fire"
   fields[5] = 4
   fields[8]  = "Android OS 14 / API-34"              # ĐÃ THAY
   fields[9]  = "Handheld"
   fields[10] = "Viettel"                             # ĐÃ THAY
   fields[11] = "5G"                                  # ĐÃ THAY
   fields[12] = 1440                                  # ĐÃ THAY
   fields[13] = 3120                                  # ĐÃ THAY
   fields[15] = "ARM64 FP ASIMD AES | 3200 | 12"      # ĐÃ THAY
   fields[17] = "Adreno (TM) 740"                     # ĐÃ THAY
   fields[18] = "OpenGL ES 3.2"
   fields[19] = "Google|a1b2c3d4-e5f6-7890-abcd-ef1234567890"  # ĐÃ THAY
   fields[20] = "192.168.1.100"                       # ĐÃ THAY
   fields[21] = self.language
   fields[22] = "40254b1770e14131d3879ea51acb93ad"
   fields[24] = "Handheld"
   fields[25] = "Xiaomi 14 Pro"                       # ĐÃ THAY
   fields[41] = "Viettel"                             # ĐÃ THAY
   fields[42] = "5G"                                  # ĐÃ THAY
