...
class APIClient:
 def __init__(self):
  ...
  "Host": "loginbp.ggpolarbear.com",          # ← đã đổi
 ...
 def auth_guest_token(self, uid, password):
  ...
  try:
   data = requests.post(
    "https://ffmconnect.live.gop.garenanow.com/oauth/guest/token/grant",  # ← đã đổi URL
    data=payload,
    headers={
 ...
 def MajorLogin(self):
  ...
  fields[8] = "Android OS 13 / API-33"
  fields[9] = "Handheld"
  fields[10] = "Verizon Wireless"
  fields[11] = "WIFI"
  fields[12] = 1280
  fields[13] = 960
  fields[15] = "ARM64 FP ASIMD AES | 2800 | 8"
  fields[16] = 5951
